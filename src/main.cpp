...
int main() {
    ...
    world.add(make_shared<Mesh>("../res/models/plate.obj", material_plate, point3(-0.67, 1.0, 0.25)));
    world.add(make_shared<Mesh>("../res/models/plate.obj", material_plate, point3(-0.67, 1.0, -0.25)));
    world.add(make_shared<Mesh>("../res/models/glass.obj", material_glass, point3(0.86, 1.0, 0.1)));
    world.add(make_shared<Mesh>("../res/models/glass.obj", material_glass, point3(0.43, 1.0, -0.13)));
    world.add(make_shared<Mesh>("../res/models/glass.obj", material_glass, point3(-0.43, 1.0, 0.1)));
    world.add(make_shared<Mesh>("../res/models/glass.obj", material_glass, point3(-0.86, 1.0, -0.13)));
    world.add(make_shared<Mesh>("../res/models/bowl.obj", material_bowl, point3(0.0, 1.0, 0.0)));
    world.add(make_shared<Plane>(point3(1000.0, 1000.0, 1000.0), vec3(-0.38, -0.66, -0.64), material_sun));
    ...
    cam.vfov     = 70;
    cam.lookfrom = point3(0.6, 1.2, 0.8);
